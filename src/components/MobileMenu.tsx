        ...
        <AnimatePresence custom={dimensions} mode='wait' onExitComplete={onAnimationCompleteCallback}>
            {isOpen && (
                <FocusTrap
                    ...
                    focusTrapOptions={{
                        initialFocus: () => popoverRef.current?.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])') || popoverRef.current || false, // Try to focus first interactive element
                        ...
                        onDeactivate: () => { // When trap deactivates (e.g., menu closes)
